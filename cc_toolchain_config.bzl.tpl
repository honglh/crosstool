...
CXX_BUILTIN_INCLUDE_DIRECTORIES = {
    ...
    "aarch64": [
        "%{target_toolchain_include_root}%/usr/aarch64-linux-gnu/include/c++/%d" % GCC_VERSION,
        "%{target_toolchain_include_root}%/usr/aarch64-linux-gnu/include/c++/%d/aarch64-linux-gnu" % GCC_VERSION,
        "%{target_toolchain_include_root}%/usr/aarch64-linux-gnu/include/c++/%d/backward" % GCC_VERSION,
        "%{target_toolchain_include_root}%/usr/lib/gcc-cross/aarch64-linux-gnu/%d/include" % GCC_VERSION,
        "%{target_toolchain_include_root}%/usr/lib/gcc-cross/aarch64-linux-gnu/%d/include-fixed" % GCC_VERSION,
        "%{target_toolchain_include_root}%/usr/lib/gcc/aarch64-linux-gnu/%d/include" % GCC_VERSION,
        "%{target_toolchain_include_root}%/usr/aarch64-linux-gnu/include",
        ...
        "%{target_toolchain_include_root}%/usr/lib/gcc/aarch64-linux-gnu/%{gcc_version_full}%/include",
        "%{target_toolchain_include_root}%/usr/lib/gcc/aarch64-linux-gnu/%{gcc_version_full}%/include-fixed",
        "%{target_toolchain_include_root}%/usr/aarch64-linux-gnu/include/c++/%{gcc_version_full}%",
        "%{target_toolchain_include_root}%/usr/aarch64-linux-gnu/include/c++/%{gcc_version_full}%/aarch64-linux-gnu",
        "%{target_toolchain_include_root}%/usr/aarch64-linux-gnu/include/c++/%{gcc_version_full}%/backward",
    ],
    "riscv64": [
