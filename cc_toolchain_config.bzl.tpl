...
CXX_BUILTIN_INCLUDE_DIRECTORIES = {
    ...
    "aarch64": [
        ...
        "/usr/include",
        "/usr/aarch64-linux-gnu/include/c++/%{gcc_version_full}%",
        "/usr/aarch64-linux-gnu/include/c++/%{gcc_version_full}%/aarch64-linux-gnu",
        "/usr/aarch64-linux-gnu/include/c++/%{gcc_version_full}%/backward",
        "/usr/lib/gcc/aarch64-linux-gnu/%{gcc_version_full}%/include",
        "/usr/lib/gcc/aarch64-linux-gnu/%{gcc_version_full}%/include-fixed",
        "/usr/aarch64-linux-gnu/libc/usr/include",
    ],
    "riscv64": [
